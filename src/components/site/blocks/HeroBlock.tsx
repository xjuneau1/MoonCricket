...
export function HeroBlock({ block }: HeroBlockProps) {
  return (
    <SectionShell id={block.id} className="pt-24 md:pt-28">
      <div className="relative overflow-hidden rounded-3xl border border-[var(--brand)]/18 bg-[var(--surface)] p-8 shadow-[0_22px_50px_rgba(43,67,102,0.16)] backdrop-blur-sm md:p-12">
        ...
        <div className="relative flex flex-col gap-7">
          ...
          <p className="max-w-2xl text-lg leading-relaxed text-[var(--text-muted)] md:text-xl">{block.subtitle}</p>
